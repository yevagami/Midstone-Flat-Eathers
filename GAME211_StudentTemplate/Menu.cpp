...
#pragma region Rendering
	...
	bool Button::RenderText() {
		...
		buttonTextSurface = TTF_RenderText_Solid(buttonTextFont, text, ui::SDL_COLOR_BLACK);
		if (!buttonTextSurface) { return false; }

		// 3. set up a texture for the surface
		buttonTextTexture = SDL_CreateTextureFromSurface(buttonRenderer, buttonTextSurface);
